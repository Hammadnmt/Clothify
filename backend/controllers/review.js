...
//@desc Get all logged in User reviews
...
exports.create = exceptionHandler(async (req, res, next) => {
  ...
  const orderVerification = await Order.findOne({
    user,
    "items.product": product,
  });

  const isVerifiedPurchase = !!orderVerification;
...
//@route PATCH /api/v1/reviews/helpful/:id
//@access Private
